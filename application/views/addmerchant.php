...
<li class="breadcrumb-item"><a href="<?php echo base_url();?>merchants">Merchants</a></li>
<li class="breadcrumb-item <?php if($this->uri->segment(1)=='addmerchant') { echo 'active';}?>"><a href="<?php echo base_url();?>addmerchant">Add Merchant</a></li>
</ol>
</div>

<div class="card mb-4">
<h6 class="card-header">Add Merchant</h6>
<div class="card-body">
...
<input type="text" name="shopname" id="shopname" class="form-control" placeholder="Shop Name" maxlength="200">
<div class="clearfix"></div>
</div>

<div class="form-group col-md-6">
<label class="form-label">Shop Owner Name</label>
<input type="text" name="shopowner" id="shopowner" class="form-control" placeholder="Shop Owner Name" maxlength="200">
<div class="clearfix"></div>
</div>
...
<input type="text" name="shopaddress" id="shopaddress" class="form-control" placeholder="Shop Address" maxlength="200">
<div class="clearfix"></div>
</div>
