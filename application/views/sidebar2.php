...
<li class="sidenav-item <?php if($this->uri->segment(1)=='dpdashboard') { echo 'open active';}?>">
<a href="<?php echo base_url();?>dpdashboard" class="sidenav-link">
<i class="sidenav-icon feather icon-home"></i>
<div>Dashboard</div>
<div class="pl-1 ml-auto">
                     <div class="badge badge-danger">Delivery Boy</div>
                  </div>
</a>
</li>
