<?php include("header_div.php");?>
<?php //include("content.php");?>
<div class="layout-content">

<div class="container-fluid flex-grow-1 container-p-y">
<h4 class="font-weight-bold py-3 mb-0">Dashboard (<?php echo $_SESSION['division'];?>)</h4>
<a href="<?php echo base_url();?>home/adminlogin"><h4 class="float-right text-success"><-Back to main Dashboard</h4></a>

<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="<?php echo base_url();?><?php echo $_SESSION['division'];?>"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item active"><a href="<?php echo base_url();?><?php echo $_SESSION['division'];?>">Dashboard</a></li>
...
<h4 class="font-weight-bold py-3 mb-0"></h4>
  ...
  <div class="col-lg-3 col-md-6" style="float:right">
    ...
    <select class="form-control" id="exampleFormControlSelect1" onchange="location = this.value;">
     ...
     <option value="<?php echo base_url();?>home/dashboard_comp/<?php echo $_SESSION['division'];?>?id=<?php echo $data['com_name'];?>"><?php echo $data['com_name'];?></option>
