...
<li class="breadcrumb-item <?php if($this->uri->segment(1)=='edituser/'.$customer->id) { echo 'active';}?>"><a href="<?php echo base_url();?>edituser/<?php echo $customer->id;?>">Edit User</a></li>
</ol>
</div>
...
<div class="card-body">
<form action="<?php echo base_url();?>edit_user" method="post" enctype="multipart/form-data">
<div class="form-row">
