...
<tr class="fieldGroupCopy">
<td><input class="form-control" type="text" id="sno" name="sno[]"/></td>
<td><div class="search-container">

<input type="text" id="search" placeholder="Product Name" name="search[]" required class="form-control"/>
<div id="display" style="background: white; width: 540px;"></div>
...
<td><select class="custom-select" name="unit[]" id="unit">
<option>Select</option>
<?php foreach($unit as $ut) { ?>
<option value="<?php echo $ut['id'];?>"><?php echo $ut['unit'];?></option>
<?php } ?>
</select></td>
<td><input class="form-control" type="text" id="quantity" name="quantity[]"/></td>
<td><input class="form-control" type="text" id="basic" name="basic[]"/></td>
<td><select class="custom-select" name="gst[]" id="gst">
<option>Select</option>
<?php foreach($tax as $tx) { ?>
<option value="<?php echo $tx['id'];?>"><?php echo $tx['tax'];?></option>
<?php } ?>
</select></td>
<td><input class="form-control" type="text" id="rate" name="rate[]"/></td>
<td><input class="form-control" type="text" id="freeqty" name="freeqty[]"/></td>
<td><input class="form-control" type="text" id="discountper" name="discountper[]"/></td>
<td><input class="form-control" type="text" id="discountamt" name="discountamt[]"/></td>
<td><input class="form-control" type="text" id="rate" name="rate[]"/></td>
<td>
