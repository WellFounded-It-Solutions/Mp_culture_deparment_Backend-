...
<?php
                          if($cust['status'] == '1') {
                           ?>
                                                    <a href="<?php echo base_url();?>home/manufacturerstatus/<?php echo $cust['id']; ?>" onclick="return confirm('Are you sure you want to change?');"><button class="btn btn-success">Active</button></a>

                                                    <?php
                          } else if($cust['status'] == '0') {
                            ?>
                                                        <a href="<?php echo base_url();?>home/manufacturerstatus/<?php echo $cust['id']; ?>" onclick="return confirm('Are you sure you want to change?');"><button class="btn btn-danger">Deactive</button></a>
                                                        <?php
                          } 
                            ?>
                                            ...
                                            <a href="<?php echo base_url();?>deletemanufacturer/<?php echo $cust['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete?');"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                            </td>
                                            </tr>
