...
<link rel="icon" type="image/x-icon" href="https://jusmarktech.in/mpculturedept/img/core-img/ashish%20ji.png">
...
<img src="https://jusmarktech.in/mpculturedept/img/core-img/ashish%20ji.png" alt="Brand Logo" class="img-fluid" tyle="max-width: 160% !important;margin-left: -18px;">
...
<form action="<?php echo base_url();?>home/loginartist" id="loginForm" method="post">
<div class="form-group">
<label class="form-label">Mobile No</label>
<input type="number" name="mobile"  maxlenght="10"  minlenght="10" class="form-control">
<div class="clearfix"></div>
</div>
<div class="form-group">
...
<a href="https://jusmarktech.in/mpculturedept/admin/home/login_detail">Sign Up</a>
</div>
</div> 
</div>
</div>
