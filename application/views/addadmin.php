...
<li class="breadcrumb-item"><a href="<?php echo base_url();?>admins">Admin</a></li>
<li class="breadcrumb-item <?php if($this->uri->segment(1)=='addadmin') { echo 'active';}?>"><a href="<?php echo base_url();?>addadmin">Add Admin</a></li>
</ol>
</div>

<div class="card mb-4">
<h6 class="card-header">Add Admin</h6>
<div class="card-body"> <?php echo $this->session->flashdata('msg'); ?>
<form action="<?php echo base_url();?>home/add_admin" method="post" enctype="multipart/form-data">
<div class="form-row">
...
<input type="text" name="types" value="Admin" class="form-control" placeholder="">
