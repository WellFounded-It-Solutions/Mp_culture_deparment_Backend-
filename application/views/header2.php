<?php
$session = $this->session->userdata('dp_session');
if(!$session['dp_id']){
redirect(base_url()); 
}  
?>
...
<img src="<?php echo base_url();?>/assets/img/user/<?php echo $session['dp_img'];?>"" alt class="d-block ui-w-30 rounded-circle">
<span class="px-1 mr-lg-2 ml-2 ml-lg-0"><?php echo $session['dp_name'];?></span>
</span>
</a>
<div class="dropdown-menu dropdown-menu-right">
...
<a href="<?php echo base_url();?>dplogout" class="dropdown-item">
