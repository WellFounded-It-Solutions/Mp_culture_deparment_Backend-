...
<?php
                          if($cust['status'] == '1') {
                           ?>
                                                    <a href="<?php echo base_url();?>home/areastatus/<?php echo $cust['id']; ?>" onclick="return confirm('are you sure you want to chnage?');"><button class="btn btn-success">Active</button></a>

                                                    <?php
                          } else if($cust['status'] == '0') {
                            ?>
                                                        <a href="<?php echo base_url();?>home/areastatus/<?php echo $cust['id']; ?>" onclick="return confirm('are you sure you want to chnage?');"><button class="btn btn-danger">Deactive</button></a>
                                                        <?php
                          } 
                            ?>
</td>
                                            ...
                                            <a href="<?php echo base_url();?>deletearea/<?php echo $cust['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('are you sure you want to chnage?');"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                            </td>
                                            </tr>
