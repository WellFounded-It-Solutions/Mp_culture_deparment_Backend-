...
<h4 class="font-weight-bold py-3 mb-0">Quotation</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
<li class="breadcrumb-item <?php if($this->uri->segment(1)=='purchaseorders') { echo 'active';}?>"><a href="<?php echo base_url();?>purchaseorders">Quotation</a></li>
</ol>
</div>
<div class="row">
...
<span class="text-info">Today Quotation Orders</span>
</div>
<div class="col-md-3 col-xs-6">
...
<span class="text-success">Active Quotation Orders</span>
</div>
<div class="col-md-3 col-xs-6">
...
<span class="text-danger">Inactive Quotation Orders</span>
</div>
<div class="col-md-3 col-xs-6">
...
<span class="text-dark">Total Quotation</span>
</div>
...
<a href="<?php echo base_url();?>home/addquatation"><button class="btn btn-success btn-sm mb-3"><i class="feather icon-plus"></i> Add Quotation</button></a>
</div>
</div>
