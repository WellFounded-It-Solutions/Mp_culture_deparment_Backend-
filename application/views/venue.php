               ...
               <div class="card-body">
                  <div class="row align-items-center m-l-0">
                     ...
                     <div class="col-sm-6 text-right">
                        <button class="btn btn-success btn-sm mb-3 btn-round" data-toggle="modal" data-target="#modal-report"><i class="feather icon-plus"></i> Add Venue</button>
                     </div>
                  </div>
                     ...
                     data-url="">
                        <thead>
                           <tr>
                              ...
                              <th>Venue Contact 1 </th>
                              <th>Venue Contact 2</th>
                           </tr>
                        </thead>
                        <tbody>
                           <tr>
                        ...
                        <form>
                           ...
                           <div class="col-sm-6">
                                 <div class="form-group">
                                    <label class="floating-label" for="Name">Venue  Name </label>
                                    <input type="text" class="form-control" id="Name" placeholder="Enter">
                                 </div>
                              </div>
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    <label class="floating-label" for="Name">Venue  Contact</label>
                                    <input type="number" class="form-control" id="Name" placeholder="Enter">
                                 </div>
                              </div>
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    <label class="floating-label" for="Name">Venue  Website</label>
                                    <input type="number" class="form-control" id="Name" placeholder="Enter">
                                 </div>
                              </div>
                              <div class="col-sm-6">
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group fill">
                                    <label class="floating-label" for="Icon">Venue Logo</label>
                                    <input type="file" class="form-control" id="Icon" placeholder="sdf">
                                 </div>
                              </div>
                              <div class="col-sm-6">
                                 <div class="form-group fill">
                                    <label class="floating-label" for="Icon">Venue  Images</label>
                                    <input type="file" class="form-control" id="Icon" placeholder="sdf">
                                 </div>
                              </div>
                              <div class="col-sm-6">
                                 <div class="form-group fill">
                                    <label class="floating-label" for="Email">Venue  About </label>
                                    <input type="text" class="form-control" id="Email" placeholder="Enter">
                                 </div>
                              </div>
                              <div class="col-sm-6">
