...
<h4 class="font-weight-bold py-3 mb-0">Cities</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="<?php echo base_url();?>dashboard"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
<li class="breadcrumb-item <?php if($this->uri->segment(1)=='city') { echo 'active';}?>"><a href="<?php echo base_url();?>city">Cities</a></li>
</ol>
</div>
<div class="row">
         ...
         <div class="card">
            ...
            <?php } ?></div>
                                    <div class="col-sm-6 text-right">
                                       <button class="btn btn-success btn-sm mb-3 btn-round" data-toggle="modal" data-target="#modal-report"><i class="feather icon-plus"></i> Add city</button>
                                    </div>
                                 </div>
...
<?php
                          if($cust['status'] == '1') {
                           ?>
                                                    <a href="<?php echo base_url();?>home/citystatus/<?php echo $cust['id']; ?>" onclick="return confirm('are you sure you want to change?');"><button class="btn btn-success">Active</button></a>

                                                    <?php
                          } else if($cust['status'] == '0') {
                            ?>
                                                        <a href="<?php echo base_url();?>home/citystatus/<?php echo $cust['id']; ?>" onclick="return confirm('are you sure you want to change?');><button class="btn btn-danger">Deactive</button></a>
                                                        <?php
                          } 
                            ?>
</td>
                                            ...
                                            <a href="<?php echo base_url();?>deletecity/<?php echo $cust['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('are you sure you want to delete?');"><i class="feather icon-trash-2" ></i>&nbsp;Delete </a>
                                            </td>
                                            </tr>
         ...
         <div class="modal-dialog ">
            <div class="modal-content">
               ...
               <form action="<?php echo base_url();?>edit_city" method="post" enctype="multipart/form-data">
...
<input type="text" name="city" id="city" class="form-control" placeholder="City Name" maxlength="255" value="<?php echo $cust['city']; ?>" required>
</div>
...
<div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
               <form action="<?php echo base_url();?>add_city" method="post" enctype="multipart/form-data">
               <div class="row">
...
<div class="form-group col-sm-6">
<label class="floating-label">City Name</label>
<input type="text" name="city" id="city" class="form-control" placeholder="City Name" maxlength="100" required>
</div>

<div class="col-sm-12">
<button class="btn btn-primary" type="submit">Save</button>
<button class="btn btn-danger" data-dismiss="modal">Exit</button> OR 
<a href="<?php echo base_url();?>area"><button class="btn btn-primary" type="button">Add Area</button></a>
</div>
</div>
</form>
               </div>
