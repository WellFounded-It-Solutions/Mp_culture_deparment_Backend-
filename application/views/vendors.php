...
<h4 class="font-weight-bold py-3 mb-0">Vendors <?php //echo $_SESSION['division'];?></h4>
...
<a href="<?php echo base_url();?>home/addvendor"><button class="btn btn-success btn-sm mb-3"><i class="feather icon-plus"></i> Add vendor</button></a>
</div>
</div>
...
<tr>
<td><?php echo $i;?></td>
<td><a href="<?php echo base_url();?>/home/vendor_info"><?php echo $cust['name'];?></a>
<!-- <small class="d-block">
<a href="#!">View</a> |
<a href="#!">Contacts</a> |
