...
<h4 class="font-weight-bold py-3 mb-0"><?php echo $_SESSION['company'];?> (<?php echo $_SESSION['year'];?>)</h4>
<a href="<?php echo base_url();?><?php echo $_SESSION['division'];?>"><h4 class="float-right text-primary"> Back to Division  </h4></a>
...
<!-- <a href="<?php echo base_url();?>home/dashboard_comp/<?php echo $_SESSION['division'];?>?id=<?php echo $_SESSION['company'];?>"><h4 class="float-right text-success"><-Back to Company</h4></a>
 -->
...
<h4 class="font-weight-bold py-3 mb-0"></h4>
  <div class="col-lg-3 col-md-6">
    ...
    <select class="form-control" id="exampleFormControlSelect1" onchange="location = this.value;">
      ...
      <!-- <option value="<?php echo base_url();?>home/dashboard_comp/<?php echo $_SESSION['division'];?>?id=<?php echo $_SESSION['company'];?>">All Data</option> -->
