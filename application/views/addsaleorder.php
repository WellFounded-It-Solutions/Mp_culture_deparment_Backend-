    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item <?php if($this->uri->segment(1)=='addpurchaseorder') { echo 'active';}?>"><a
                        href="<?php echo base_url();?>home/addpurchaseorder">Add Sale Order</a></li>
            </ol>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo base_url();?>home/add_purchaseorder" method="post" enctype="multipart/form-data" id="dynamic_field">
                <input type="hidden" id="counter" value="1">
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            <label class="form-label">Date</label>
                            <input type="text" name="purchasedate" id="purchasedate" class="form-control" placeholder="Purchase Date" value="<?php echo date("d M y");?>" readonly>
...
<div class="clearfix"></div>
          ...
          <!--   <tbody>
            ...
            <th colspan="12">Amount (in words): <input class="form-control" type="text" id="word" name="amtword" readonly/></th>
              ...
              <tbody>
            <tr>
            <th colspan="6" class="text-right">Order Tax</th>
            <th><input class="form-control totalquantity" type="text" id="" name="totalquantity"  placeholder="Order Tax"/></th>
            <th colspan="6" class="text-right">Shipping/Transportation Cost</th>
            <th><input class="form-control totalamount" type="text" id="" name="totalamount"  placeholder="Shipping/Transportation" /></th>
            <!--<th colspan="4" class="text-right">Tax Amount </th>
            <th><input class="form-control" type="text" id="totaltax" name="totaltax" /></th>-->
            </tr>
              <tr>
            <th colspan="6" class="text-right"></th>
            <th><input class="form-control totalquantity" type="text" id="" name="totalquantity" readonly /></th>
            <th colspan="6" class="text-right"> </th>
            <th></th>
            <!--<th colspan="4" class="text-right">Tax Amount </th>
            <th><input class="form-control" type="text" id="totaltax" name="totaltax" /></th>-->
           ...
           <!--  <tr>
            ...
            <tr>
            <th colspan="12">Remark/Note: <textarea class="form-control" type="text" id="word" name=""></textarea></th>
            </tr>
            </tbody>
            </table>
            </div>
...
function calculateSubTotal1() {
  ...
  $('#nettotal').val(Math.round(subtotal));
  /*}
  else if(rate)
  {
    $('.rate').each(function() {
