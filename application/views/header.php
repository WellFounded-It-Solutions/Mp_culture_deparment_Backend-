...
<link rel="stylesheet" href="<?php echo base_url();?>assets/libs/bootstrap-datepicker/bootstrap-datepicker.css">
<link rel="stylesheet" href="<?php echo base_url();?>assets/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.css">
<link rel="stylesheet" href="<?php echo base_url();?>assets/libs/bootstrap-material-datetimepicker/bootstrap-material-datetimepicker.css">
<link rel="stylesheet" href="<?php echo base_url();?>assets/libs/timepicker/timepicker.css">
<link rel="stylesheet" href="<?php echo base_url();?>assets/libs/minicolors/minicolors.css">
</head>
<style>
    .navbar.bg-dark {
...
<img src="https://jusmarktech.in/Culture/img/core-img/ashish%20ji.png" alt="Brand Logo" class="img-responsive" width="50px">
</span>
<span class="app-brand-text demo font-weight-normal ml-2">Culture</span>
</a>
...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIe7BDPl-iiYI2cBuLxqnhqkHO9fZidByZnJ8yuwz887CJzQLNm_KNNknMkaTrohkVg2g&usqp=CAU" alt="" class="d-block ui-w-30 rounded-circle">
<?php if($session['roles']=='Admin') {?>
<span class="px-1 mr-lg-2 ml-2 ml-lg-0"> Admin</span>
<?php }else if($session['roles']=='User') {?>
<span class="px-1 mr-lg-2 ml-2 ml-lg-0"> Artist</span>
<?php } ?>
</span>
</a>
<div class="dropdown-menu dropdown-menu-right">
...
<?php if($session['roles']=='Admin') {?>
<a href="<?php echo base_url();?>home/logoutadmin" class="dropdown-item">
...
<span class="px-1 mr-lg-2 ml-2 ml-lg-0" style="color: black;"><?php //echo $session['admin_name'];?>Admin</span>
</span>
</a>
<div class="dropdown-menu dropdown-menu-right">
