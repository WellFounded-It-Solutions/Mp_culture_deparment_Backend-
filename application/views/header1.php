<?php
$session = $this->session->userdata('emp_session');
if(!$session['emp_id']){
redirect(base_url()); 
}  
?>
...
<link rel="icon" type="image/x-icon" href="<?php echo base_url();?>assets/img/jusmarkfav.ico">
...
<img src="<?php echo base_url();?>/assets/img/user/<?php echo $session['emp_img'];?>" alt class="d-block ui-w-30 rounded-circle">
<span class="px-1 mr-lg-2 ml-2 ml-lg-0"><?php echo $session['emp_name'];?></span>
</span>
</a>
<div class="dropdown-menu dropdown-menu-right">
...
<a href="<?php echo base_url();?>emplogout" class="dropdown-item">
