         ...
         <div class="card">
            ...
            <?php } ?></div>
                                    <div class="col-sm-6 text-right">
                                       <button class="btn btn-success btn-sm mb-3 btn-round" data-toggle="modal" data-target="#modal-report"><i class="feather icon-plus"></i> Add Company</button>
                                    </div>
                                 </div>
...
<tr>
<td><?php echo $i;?></td>
<td><?php echo $cust['com_name'];?></td>
<!-- <td><img class="" src="<?php echo base_url();?>assets/img/user/<?php echo $cust['div_icon'];?>" alt="Product image"></td> -->
<td><?php echo $cust['com_date'];?></td>
<td>
<?php
                          if($cust['come_status'] == '1') {
                           ?>
                                                    <a href="<?php echo base_url();?>home/categorystatus/<?php echo $cust['com_id']; ?>"><button class="btn btn-success">Active</button></a>

                                                    <?php
                          } else if($cust['come_status'] == '0') {
                            ?>
                                                        <a href="<?php echo base_url();?>home/categorystatus/<?php echo $cust['com_id']; ?>"><button class="btn btn-danger">Deactive</button></a>
                                                        <?php
                          } 
                            ?>
</td>
                                            <td>
											<a href="!#"  class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-report-1<?php echo $cust['com_id']; ?>">Edit</a>

                                            

                                            <a href="<?php echo base_url();?>deletecategory/<?php echo $cust['com_id']; ?>" class="btn btn-danger btn-sm"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                            </td>
                                            </tr>

                                            <div class="modal fade" id="modal-report-1<?php echo $cust['com_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
         <div class="modal-dialog ">
            <div class="modal-content">
               ...
               <input type="hidden" name="id" class="form-control" value="<?php echo $cust['com_id'];?>">
<div class="row">
...
<div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
               <form action="<?php echo base_url();?>home/add_company" method="post" enctype="multipart/form-data">
               <div class="row">
...
<input type="number" name="mobile" id="category" class="form-control" placeholder="Contact number" maxlength="100" required>
</div>
 <div class="form-group col-sm-6">
...
<textarea class="form-control" name="address" id="description" rows="10"></textarea>
</div> 
