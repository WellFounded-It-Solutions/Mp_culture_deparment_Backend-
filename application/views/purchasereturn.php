...
<span class="text-info">Today Purchase Return</span>
</div>
<!-- <div class="col-md-3 col-xs-6">
...
<span class="text-success">Active Purchase Return</span>
</div>
<div class="col-md-3 col-xs-6">
...
<span class="text-danger">Inactive Purchase Return</span>
</div> -->
<div class="col-md-3 col-xs-6">
...
<span class="text-dark">Total Purchase Return</span>
</div>
...
<a href="<?php echo base_url();?>home/addpurchasereturn"><button class="btn btn-success btn-sm mb-3"><i class="feather icon-plus"></i> Add Purchase Return</button></a>
</div>
</div>
