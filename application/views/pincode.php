...
<h4 class="font-weight-bold py-3 mb-0">Pin Codes</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="<?php echo base_url();?>dashboard"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
<li class="breadcrumb-item <?php if($this->uri->segment(1)=='pincode') { echo 'active';}?>"><a href="<?php echo base_url();?>pincode">Pin Codes</a></li>
</ol>
</div>
<div class="row">
...
<?php include("pincodecontent.php");?>
         ...
         <div class="card">
            ...
            <?php } ?></div>
                                    <div class="col-sm-6 text-right">
                                       <button class="btn btn-success btn-sm mb-3 btn-round" data-toggle="modal" data-target="#modal-report"><i class="feather icon-plus"></i> Add Pin Code</button>
                                    </div>
                                 </div>
...
<?php
                          if($cust['status'] == '1') {
                           ?>
                                                    <a href="<?php echo base_url();?>home/pincodestatus/<?php echo $cust['id']; ?>" onclick="return confirm('Are you sure you want to chnage?');"><button class="btn btn-success">Active</button></a>

                                                    <?php
                          } else if($cust['status'] == '0') {
                            ?>
                                                        <a href="<?php echo base_url();?>home/pincodestatus/<?php echo $cust['id']; ?>" onclick="return confirm('Are you sure you want to chnage?');"><button class="btn btn-danger">Deactive</button></a>
                                                        <?php
                          } 
                            ?>
</td>
                                            ...
                                            <a href="<?php echo base_url();?>deletepincode/<?php echo $cust['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete?');"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                            </td>
                                            </tr>
         ...
         <div class="modal-dialog ">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title">Edit Pin Code</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <div class="modal-body">
               <form action="<?php echo base_url();?>edit_pincode" method="post" enctype="multipart/form-data">
...
<select class="custom-select" name="areaid" id="areaid" required>
<option value="<?php echo $cust['area_id'];?>" selected><?php foreach($area as $ar1) {
            if($ar1['id']==$cust['area_id'])
            {
               echo $ar1['area'];
            }
         }?></option>
...
<input type="text" name="pincode" id="pincode" class="form-control" placeholder="Pin Code" maxlength="255" value="<?php echo $cust['pincode']; ?>" required>
</div>
...
<div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title">Add Pin Code</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <div class="modal-body">
               <form action="<?php echo base_url();?>add_pincode" method="post" enctype="multipart/form-data">
               <div class="row">
...
<div class="form-group col-sm-6">
<label class="floating-label">Pin Code</label>
<input type="text" name="pincode" id="pincode" class="form-control" placeholder="Pincode" maxlength="100" required>
</div>
