            ...
            <?php } ?></div>
                                 ...
                                 <div class="table-responsive">
                                    <table id="report-table" class="table table-bordered table-striped mb-0">
                                       ...
                                       <?php 
$i=1;
foreach($categoryinactive as $cust)
{
?>
<tr>
<td><?php echo $i;?></td>
...
<div class="form-group col-sm-6">
<label class="floating-label">Category Name</label>
<input type="text" name="category" id="category" class="form-control" placeholder="Category Name like Biscuit, Oil" maxlength="100" required>
</div>
<div class="form-group col-sm-6">
<label class="floating-label">Description</label>
