...
<a href="<?php echo base_url();?>division_dashboard?id=<?php echo $_SESSION['division'];?>" class="sidenav-link">
...
<a href="<?php echo base_url();?>home/company" class="sidenav-link">
<i class=""></i>
<div>Company/Firm</div>
</a>
</li>
