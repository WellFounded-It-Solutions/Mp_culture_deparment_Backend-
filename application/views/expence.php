...
<h4 class="font-weight-bold py-3 mb-0">Expense</h4>
<div class="text-muted small mt-0 mb-4 d-block breadcrumb">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="<?php echo base_url();?>dashboard"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item"><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
<li class="breadcrumb-item <?php if($this->uri->segment(1)=='subcategory') { echo 'active';}?>"><a href="<?php echo base_url();?>subcategory">Expense</a></li>
</ol>
</div>
<div class="row">
<div class="col-sm-12">
...
<span class="text-danger">Inactive Expense</span>
</div>
<div class="col-md-3 col-xs-6">
<h3 class="text-dark"><a href="#" class="text-dark"><?php if(isset($countcategoryactive)){echo $countcategoryactive;} else { echo "";}?></a></h3>
<span class="text-dark">Total Expense</span>
</div>
         ...
         <div class="card">
            ...
            <?php } ?></div>
                                    <div class="col-sm-6 text-right">
                                       <button class="btn btn-success btn-sm mb-3 btn-round" data-toggle="modal" data-target="#modal-report"><i class="feather icon-plus"></i> Add Expense</button>
                                    </div>
                                 </div>
...
<td><?php 
foreach($expence as $cat){
    if($cat['id']==$cust['exexpenc_head'])
    {
        echo $cat['name'];
    }
}
...
<?php
                          if($cust['status'] == '1') {
                           ?>
                            ...
                            ?>
                                            ...
                                            <a href="<?php echo base_url();?>home/deleteexpence/<?php echo $cust['id']; ?>" class="btn btn-danger btn-sm"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                            </td>
                                            </tr>
         ...
         <div class="modal-dialog ">
            <div class="modal-content">
               ...
               <form action="<?php echo base_url();?>home/edit_expence" method="post" enctype="multipart/form-data">
               <input type="hidden" name="id" class="form-control" value="<?php echo $cust['id'];?>">
<div class="row">

<div class="form-group col-sm-6">
<label class="floating-label">Expence Head</label>  
<select class="form-control" name="pay1" id="catid" required>
     <option value="">Select </option>
<?php foreach($expence as $cat) { ?>
<option value="<?php echo $cat['id'];?>" <?php if($cust['exexpenc_head']==$cat['id']){echo "selected";}?>><?php echo $cat['name'];?></option>
<?php } ?>
</select>
</div>
<div class="form-group col-sm-6">
<label class="floating-label">Payment given to</label>  
  <select class="form-control" data-live-search="true" name="vendorid1" id="vendorid" required>
                                 <option value="">Select </option>
                                <?php foreach($vendors as $vc) { ?>
                                <option value="<?php echo $vc['id'];?>"<?php if($cust['by_whom']==$vc['id']){echo "selected";}?>><?php echo $vc['name'];?></option>
                                <?php } ?>
                            </select>
</div>
 <div class="form-group col-md-6">
                           <!--  <label class="form-label">OR </br><a href="<?php echo base_url();?>home/addvendor"><button class="btn-primary">Add Vendor</button></a></label> -->
                            <label class="form-label">OR </label></br> <a href="<?php echo base_url();?>home/add_vendors/expense"><label class="btn-primary">Add vendor</label></a>
                            <div class="clearfix"></div>
                        </div>
<div class="form-group col-sm-6">
<label class="floating-label">Price</label>
<input type="text" name="price" id="subcategory" value="<?php echo $cust['price'];?>" class="form-control" placeholder="Price" maxlength="100" required>
</div>
<div class="col-sm-12">
                        <br>
...
<div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title">Add Expence</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <div class="modal-body">
               <form action="<?php echo base_url();?>home/add_expence" method="post" enctype="multipart/form-data">
               <div class="row">
...
<div class="form-group col-sm-6">
<label class="floating-label">Expence Head</label>  
<select class="selectpicker" data-live-search="true" name="pay" id="catid" required>
     <option value="">Select </option>
<?php foreach($expence as $cat) { ?>
                              ...
                              <div class="card">
                                 ...
                                 <div class="accordion" id="accordionExample">
                                    <div class="card mb-0 shadow-none border-top">
                                       <div class="card-header" id="headingOne">
                                          <div class="custom-control custom-radio">
                                             <input type="radio" id="BillingPaypal1" value="paypal" name="billingOptions" class="custom-control-input" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" required <?php if($cust['billingOptions']=='paypal'){echo "checked";}?>>
                                    ...
                                    <div class="card mb-0 shadow-none border-top">
                                       <div class="card-header" id="headingTwo">
                                          <div class="custom-control custom-radio">
                                             <input type="radio" id="BillingCard1" name="billingOptions" value="card" class="custom-control-input collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" <?php if($cust['billingOptions']=='card'){echo "checked";}?>>
                                    ...
                                    <div class="card mb-0 shadow-none border-top">
                                       <div class="card-header" id="headingThree">
                                          <div class="custom-control custom-radio">
                                             <input type="radio" id="BillingOptRadio33" value="cheque" name="billingOption" class="custom-control-input collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" <?php if($cust['billingOptions']=='cheque'){echo "checked";}?>>
                                    ...
                                    <div class="card mb-0 shadow-none border-top">
                                       <div class="card-header" id="headingfour">
                                          <div class="custom-control custom-radio">
                                             <input type="radio" id="BillingOptRadio44" value="cash" name="billingOptions" class="custom-control-input collapsed" data-toggle="collapse" data-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour" <?php if($cust['billingOptions']=='cash'){echo "checked";}?>>
