                                    ...
                                    <table id="report-table" class="table table-bordered table-striped mb-0">
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td>Tanvir Hasan</td>
                                             <td><a href="http://html.phoenixcoded.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8afaebfee3efe4fecaeff2ebe7fae6efa4e9e5e7">[email&#160;protected]</a></td>
                                             <td>9876543</td>
                                             <td>female</td>
                                             <td>13/09/1994</td>
                                             <td>54</td>
                                             <td>o+</td>
                                             <td>
											 <a href="#!"  class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-report-1">Edit</a>
...
<div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
      ...
      <div class="modal fade" id="modal-report-1" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
